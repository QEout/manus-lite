...
Open [http://localhost:3000](http://localhost:3000) with your browser to see Manus Lite in action.
...
Manus Lite is open source software licensed under the MIT license.
